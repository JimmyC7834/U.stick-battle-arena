...
{
	// by https://github.com/Dawnosaur/platformer-movement
	// modified for the project use
	...
	public class PlayerMovement : MonoBehaviour
	{
		...
		private void Awake()
		{
			...
			_input.moveEvent += SetMovementVector;
		...
		private void SetMovementVector(Vector2 vec)
		{
			_moveInput = vec;
			if (_moveInput.x != 0)
			{
